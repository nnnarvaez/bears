...
(see `libraries/plugins/debug_node/include/bearshares/plugins/debug_node/debug_node_api.hpp`
...
The important information in the above is:
    ...
    ... "signing_key":"SHR5kvHiuWx2rkMx7efJuVdYUNSkoucrXuYRAJsacHWLxQLrJZAnJ" ...
...
If we want to take control of an account we can do so by editing its key with `debug_update_object` command like this:
    ...
    curl --data '{"jsonrpc": "2.0", "method": "call", "params": [2,"debug_update_object",[{"_action":"update","id":"2.2.28","active":{"weight_threshold":1,"key_auths":[["SHR5kvHiuWx2rkMx7efJuVdYUNSkoucrXuYRAJsacHWLxQLrJZAnJ",1]]}}]], "id": 9}]' http://127.0.0.1:6990/rpc
