...
/*
namespace bearshares { namespace plugin_tests {
...
} } // bearshares::plugin_tests

BEARSHARES_DEFINE_PLUGIN( test, bearshares::plugin_tests::test_plugin )

FC_REFLECT( bearshares::plugin_tests::test_a_operation, (account) )
FC_REFLECT( bearshares::plugin_tests::test_b_operation, (account) )

DECLARE_OPERATION_TYPE( bearshares::plugin_tests::test_op );
FC_REFLECT_TYPENAME( bearshares::plugin_tests::test_op );
DEFINE_OPERATION_TYPE( bearshares::plugin_tests::test_op );
*/
