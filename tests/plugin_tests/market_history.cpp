...
#include <bearshares/market_history/market_history_plugin.hpp>
...
{
   using namespace bearshares::market_history;
   ...
   try
   {
      ...
      BOOST_REQUIRE( bucket->high_bears == ASSET( "1.500 TESTS " ).amount );
      BOOST_REQUIRE( bucket->high_bsd == ASSET( "0.750 TBD" ).amount );
      BOOST_REQUIRE( bucket->low_bears == ASSET( "1.500 TESTS" ).amount );
      BOOST_REQUIRE( bucket->low_bsd == ASSET( "0.750 TBD" ).amount );
      BOOST_REQUIRE( bucket->open_bears == ASSET( "1.500 TESTS" ).amount );
      BOOST_REQUIRE( bucket->open_bsd == ASSET( "0.750 TBD" ).amount );
      BOOST_REQUIRE( bucket->close_bears == ASSET( "1.500 TESTS").amount );
      BOOST_REQUIRE( bucket->close_bsd == ASSET( "0.750 TBD" ).amount );
      BOOST_REQUIRE( bucket->bears_volume == ASSET( "1.500 TESTS" ).amount );
      BOOST_REQUIRE( bucket->bsd_volume == ASSET( "0.750 TBD" ).amount );
      bucket++;

      BOOST_REQUIRE( bucket->seconds == 15 );
      BOOST_REQUIRE( bucket->open == time_a + ( 60 * 90 ) );
      BOOST_REQUIRE( bucket->high_bears == ASSET( "0.500 TESTS " ).amount );
      BOOST_REQUIRE( bucket->high_bsd == ASSET( "0.250 TBD" ).amount );
      BOOST_REQUIRE( bucket->low_bears == ASSET( "0.500 TESTS" ).amount );
      BOOST_REQUIRE( bucket->low_bsd == ASSET( "0.250 TBD" ).amount );
      BOOST_REQUIRE( bucket->open_bears == ASSET( "0.500 TESTS" ).amount );
      BOOST_REQUIRE( bucket->open_bsd == ASSET( "0.250 TBD" ).amount );
      BOOST_REQUIRE( bucket->close_bears == ASSET( "0.500 TESTS").amount );
      BOOST_REQUIRE( bucket->close_bsd == ASSET( "0.250 TBD" ).amount );
      BOOST_REQUIRE( bucket->bears_volume == ASSET( "0.500 TESTS" ).amount );
      BOOST_REQUIRE( bucket->bsd_volume == ASSET( "0.250 TBD" ).amount );
      bucket++;

      BOOST_REQUIRE( bucket->seconds == 15 );
      BOOST_REQUIRE( bucket->open == time_a + ( 60 * 90 ) + 60 );
      BOOST_REQUIRE( bucket->high_bears == ASSET( "0.450 TESTS " ).amount );
      BOOST_REQUIRE( bucket->high_bsd == ASSET( "0.250 TBD" ).amount );
      BOOST_REQUIRE( bucket->low_bears == ASSET( "0.500 TESTS" ).amount );
      BOOST_REQUIRE( bucket->low_bsd == ASSET( "0.250 TBD" ).amount );
      BOOST_REQUIRE( bucket->open_bears == ASSET( "0.500 TESTS" ).amount );
      BOOST_REQUIRE( bucket->open_bsd == ASSET( "0.250 TBD" ).amount );
      BOOST_REQUIRE( bucket->close_bears == ASSET( "0.450 TESTS").amount );
      BOOST_REQUIRE( bucket->close_bsd == ASSET( "0.250 TBD" ).amount );
      BOOST_REQUIRE( bucket->bears_volume == ASSET( "0.950 TESTS" ).amount );
      BOOST_REQUIRE( bucket->bsd_volume == ASSET( "0.500 TBD" ).amount );
      bucket++;
      ...
      BOOST_REQUIRE( bucket->close_bears == ASSET( "0.450 TESTS").amount );
      BOOST_REQUIRE( bucket->close_bsd == ASSET( "0.250 TBD" ).amount );
      BOOST_REQUIRE( bucket->bears_volume == ASSET( "1.450 TESTS" ).amount );
      BOOST_REQUIRE( bucket->bsd_volume == ASSET( "0.750 TBD" ).amount );
      bucket++;
      ...
      BOOST_REQUIRE( bucket->open == BEARSHARES_GENESIS_TIME );
      BOOST_REQUIRE( bucket->high_bears == ASSET( "0.450 TESTS " ).amount );
      BOOST_REQUIRE( bucket->high_bsd == ASSET( "0.250 TBD" ).amount );
      BOOST_REQUIRE( bucket->low_bears == ASSET( "1.500 TESTS" ).amount );
      BOOST_REQUIRE( bucket->low_bsd == ASSET( "0.750 TBD" ).amount );
      ...
      BOOST_REQUIRE( bucket->close_bears == ASSET( "0.450 TESTS").amount );
      BOOST_REQUIRE( bucket->close_bsd == ASSET( "0.250 TBD" ).amount );
      BOOST_REQUIRE( bucket->bears_volume == ASSET( "2.950 TESTS" ).amount );
      BOOST_REQUIRE( bucket->bsd_volume == ASSET( "1.500 TBD" ).amount );
      bucket++;
