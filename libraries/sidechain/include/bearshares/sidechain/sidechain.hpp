...
namespace bearshares { namespace sidechain {
  using std::string;
...
#define side_ids 10
  ...
  FC_REFLECT_DERIVED( bearshares::sidechain::side_account, (graphene::db::object),
                      (sidechain)(name)(bears_balance)(dollar_balance)
                     );
