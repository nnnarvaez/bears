...
#include <bearshares/follow/follow_plugin.hpp>
...
using namespace bearshares::app;
...
using bearshares::app::discussion;
using namespace bearshares::private_message;
...
class wallet_api
{
   public:
       ...
       *  @param broadcast true if you wish to broadcast the transaction
       */
      annotated_signed_transaction create_account_delegated( string creator, asset bears_fee, asset delegated_coins, string new_account_name, string json_meta, bool broadcast );
       ...
       * @param broadcast true if you wish to broadcast the transaction
       */
       annotated_signed_transaction delegate_coining_shares( string delegator, string delegatee, asset coining_shares, bool broadcast );
       ...
       * @param broadcast true if you wish to broadcast the transaction
       */
      annotated_signed_transaction transfer_to_coining(string from, string to, asset amount, bool broadcast = false);
       ...
       * @param broadcast true if you wish to broadcast the transaction
       */
      annotated_signed_transaction withdraw_coining( string from, asset coining_shares, bool broadcast = false );
       ...
       * @param broadcast true if you wish to broadcast the transaction.
       */
      annotated_signed_transaction set_withdraw_coining_route( string from, string to, uint16_t percent, bool auto_coin, bool broadcast = false );
       ...
       *  @param broadcast true if you wish to broadcast the transaction
       */
      annotated_signed_transaction convert_bsd( string from, asset amount, bool broadcast = false );
       ...
       *                       operations defined in `bearshares/chain/operations.hpp`
       ...
       * Bears Power. Until the challenged proves their active key, all posting rights are revoked.
       *
      ...
      annotated_signed_transaction claim_reward_balance( string account, asset reward_bears, asset reward_bsd, asset reward_coins, bool broadcast );
};
...
FC_REFLECT( bearshares::wallet::wallet_data,
            (cipher_keys)
            (ws_server)
            (ws_user)
            (ws_password)
...
FC_REFLECT( bearshares::wallet::brain_key_info, (brain_priv_key)(wif_priv_key) (pub_key))

FC_REFLECT( bearshares::wallet::plain_keys, (checksum)(keys) )

FC_REFLECT_ENUM( bearshares::wallet::authority_type, (owner)(active)(posting) )

FC_API( bearshares::wallet::wallet_api,
        /// wallet api
        (help)(gethelp)
...
FC_REFLECT( bearshares::wallet::memo_data, (from)(to)(nonce)(check)(encrypted) )
