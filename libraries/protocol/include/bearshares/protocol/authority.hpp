 ...
 * - Length is between (inclusive) BEARSHARES_MIN_ACCOUNT_NAME_LENGTH and BEARSHARES_MAX_ACCOUNT_NAME_LENGTH
 */
bool is_valid_account_name( const string& name );

bool operator == ( const authority& a, const authority& b );

} } // namespace bearshares::protocol


FC_REFLECT_TYPENAME( bearshares::protocol::authority::account_authority_map)
FC_REFLECT_TYPENAME( bearshares::protocol::authority::key_authority_map)
FC_REFLECT( bearshares::protocol::authority, (weight_threshold)(account_auths)(key_auths) )
FC_REFLECT_ENUM( bearshares::protocol::authority::classification, (owner)(active)(key)(posting) )
