...
namespace bearshares { namespace protocol {
   ...
   struct asset
   {
      asset( share_type a = 0, asset_symbol_type id = BEARS_SYMBOL )
      :amount(a),symbol(id){}
...
namespace fc {
    inline void to_variant( const bearshares::protocol::asset& var,  fc::variant& vo ) { vo = var.to_string(); }
    inline void from_variant( const fc::variant& var,  bearshares::protocol::asset& vo ) { vo = bearshares::protocol::asset::from_string( var.as_string() ); }
}

FC_REFLECT( bearshares::protocol::asset, (amount)(symbol) )
FC_REFLECT( bearshares::protocol::price, (base)(quote) )
