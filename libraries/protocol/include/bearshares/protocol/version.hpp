...
{
   class variant;
   void to_variant( const bearshares::protocol::version& v, variant& var );
   void from_variant( const variant& var, bearshares::protocol::version& v );

   void to_variant( const bearshares::protocol::hardfork_version& hv, variant& var );
   void from_variant( const variant& var, bearshares::protocol::hardfork_version& hv );
} // fc

#include <fc/reflect/reflect.hpp>
FC_REFLECT( bearshares::protocol::version, (v_num) )
FC_REFLECT_DERIVED( bearshares::protocol::hardfork_version, (bearshares::protocol::version), )

FC_REFLECT( bearshares::protocol::hardfork_version_vote, (hf_version)(hf_time) )
