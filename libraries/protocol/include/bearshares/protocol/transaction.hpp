...
namespace bearshares { namespace protocol {
   ...
   struct signed_transaction : public transaction
   {
      ...
      set<public_key_type> get_required_signatures(
         ...
         uint32_t max_recursion = BEARSHARES_MAX_SIG_CHECK_DEPTH
         )const;
...
FC_REFLECT( bearshares::protocol::transaction, (ref_block_num)(ref_block_prefix)(expiration)(operations)(extensions) )
FC_REFLECT_DERIVED( bearshares::protocol::signed_transaction, (bearshares::protocol::transaction), (signatures) )
FC_REFLECT_DERIVED( bearshares::protocol::annotated_signed_transaction, (bearshares::protocol::signed_transaction), (transaction_id)(block_num)(transaction_num) );
