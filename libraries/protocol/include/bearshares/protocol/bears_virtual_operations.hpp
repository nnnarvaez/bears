...
FC_REFLECT( bearshares::protocol::author_reward_operation, (author)(permlink)(bsd_payout)(bears_payout)(coining_payout) )
FC_REFLECT( bearshares::protocol::curation_reward_operation, (curator)(reward)(comment_author)(comment_permlink) )
FC_REFLECT( bearshares::protocol::comment_reward_operation, (author)(permlink)(payout) )
FC_REFLECT( bearshares::protocol::fill_convert_request_operation, (owner)(requestid)(amount_in)(amount_out) )
FC_REFLECT( bearshares::protocol::liquidity_reward_operation, (owner)(payout) )
FC_REFLECT( bearshares::protocol::interest_operation, (owner)(interest) )
FC_REFLECT( bearshares::protocol::fill_coining_withdraw_operation, (from_account)(to_account)(withdrawn)(deposited) )
FC_REFLECT( bearshares::protocol::shutdown_witness_operation, (owner) )
FC_REFLECT( bearshares::protocol::fill_order_operation, (current_owner)(current_orderid)(current_pays)(open_owner)(open_orderid)(open_pays) )
FC_REFLECT( bearshares::protocol::fill_transfer_from_savings_operation, (from)(to)(amount)(request_id)(memo) )
FC_REFLECT( bearshares::protocol::hardfork_operation, (hardfork_id) )
FC_REFLECT( bearshares::protocol::comment_payout_update_operation, (author)(permlink) )
FC_REFLECT( bearshares::protocol::return_coining_delegation_operation, (account)(coining_shares) )
FC_REFLECT( bearshares::protocol::comment_benefactor_reward_operation, (benefactor)(author)(permlink)(reward) )
FC_REFLECT( bearshares::protocol::producer_reward_operation, (producer)(coining_shares) )
