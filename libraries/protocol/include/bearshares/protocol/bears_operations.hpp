...
namespace bearshares { namespace protocol {
   ...
   {
      FC_ASSERT( permlink.size() < BEARSHARES_MAX_PERMLINK_LENGTH, "permlink is too long" );
   ...
   struct comment_options_operation : public base_operation
   {
      ...
      uint16_t          percent_bears_dollars  = BEARSHARES_100_PERCENT; /// the percent of Bears Dollars to key, unkept amounts will be received as Bears Power
   ...
   /**
    *  This operation converts BEARS into VFS (Coining Fund Shares) at
    *  the current exchange rate. With this operation it is possible to
    *  give another account coining shares so that faucets can
    *  pre-fund new accounts with coining shares.
    */
   struct transfer_to_coining_operation : public base_operation
   {
      account_name_type from;
      account_name_type to; ///< if null, then same as from
      asset             amount; ///< must be BEARS
   ...
   struct chain_properties
   {
      ...
      asset             account_creation_fee =
         asset( BEARSHARES_MIN_ACCOUNT_CREATION_FEE, BEARS_SYMBOL );

      /**
       *  This witnesses vote for the maximum_block_size which is used by the network
       *  to tune rate limiting and capacity
       */
      uint32_t          maximum_block_size = BEARSHARES_MIN_BLOCK_SIZE_LIMIT * 2;
      uint16_t          bsd_interest_rate  = BEARSHARES_DEFAULT_BSD_INTEREST_RATE;

      void validate()const
      {
         FC_ASSERT( account_creation_fee.amount >= BEARSHARES_MIN_ACCOUNT_CREATION_FEE);
         FC_ASSERT( maximum_block_size >= BEARSHARES_MIN_BLOCK_SIZE_LIMIT);
         FC_ASSERT( bsd_interest_rate >= 0 );
         FC_ASSERT( bsd_interest_rate <= BEARSHARES_100_PERCENT );
      }
   };
    ...
    *  The funds are deposited after BEARSHARES_CONVERSION_DELAY
    */
    ...
    * BEARSHARES_MAX_WITNESSES blocks of the head block (1 round) and the
...
FC_REFLECT( bearshares::protocol::transfer_to_savings_operation, (from)(to)(amount)(memo) )
FC_REFLECT( bearshares::protocol::transfer_from_savings_operation, (from)(request_id)(to)(amount)(memo) )
FC_REFLECT( bearshares::protocol::cancel_transfer_from_savings_operation, (from)(request_id) )

FC_REFLECT( bearshares::protocol::reset_account_operation, (reset_account)(account_to_reset)(new_owner_authority) )
FC_REFLECT( bearshares::protocol::set_reset_account_operation, (account)(current_reset_account)(reset_account) )


FC_REFLECT( bearshares::protocol::report_over_production_operation, (reporter)(first_block)(second_block) )
FC_REFLECT( bearshares::protocol::convert_operation, (owner)(requestid)(amount) )
FC_REFLECT( bearshares::protocol::feed_publish_operation, (publisher)(exchange_rate) )
FC_REFLECT( bearshares::protocol::pow, (worker)(input)(signature)(work) )
FC_REFLECT( bearshares::protocol::pow2, (input)(pow_summary) )
FC_REFLECT( bearshares::protocol::pow2_input, (worker_account)(prev_block)(nonce) )
FC_REFLECT( bearshares::protocol::equihash_pow, (input)(proof)(prev_block)(pow_summary) )
FC_REFLECT( bearshares::protocol::chain_properties, (account_creation_fee)(maximum_block_size)(bsd_interest_rate) );

FC_REFLECT_TYPENAME( bearshares::protocol::pow2_work )
FC_REFLECT( bearshares::protocol::pow_operation, (worker_account)(block_id)(nonce)(work)(props) )
FC_REFLECT( bearshares::protocol::pow2_operation, (work)(new_owner_key)(props) )

FC_REFLECT( bearshares::protocol::account_create_operation,
            (fee)
            (creator)
            (new_account_name)
            (owner)
...
FC_REFLECT( bearshares::protocol::account_create_with_delegation_operation,
            (fee)
            (delegation)
            (creator)
            (new_account_name)
...
FC_REFLECT( bearshares::protocol::account_update_operation,
            (account)
            (owner)
            (active)
            (posting)
...
FC_REFLECT( bearshares::protocol::transfer_operation, (from)(to)(amount)(memo) )
FC_REFLECT( bearshares::protocol::transfer_to_coining_operation, (from)(to)(amount) )
FC_REFLECT( bearshares::protocol::withdraw_coining_operation, (account)(coining_shares) )
FC_REFLECT( bearshares::protocol::set_withdraw_coining_route_operation, (from_account)(to_account)(percent)(auto_coin) )
FC_REFLECT( bearshares::protocol::witness_update_operation, (owner)(url)(block_signing_key)(props)(fee) )
FC_REFLECT( bearshares::protocol::account_witness_vote_operation, (account)(witness)(approve) )
FC_REFLECT( bearshares::protocol::account_witness_proxy_operation, (account)(proxy) )
FC_REFLECT( bearshares::protocol::comment_operation, (parent_author)(parent_permlink)(author)(permlink)(title)(body)(json_metadata) )
FC_REFLECT( bearshares::protocol::vote_operation, (voter)(author)(permlink)(weight) )
FC_REFLECT( bearshares::protocol::custom_operation, (required_auths)(id)(data) )
FC_REFLECT( bearshares::protocol::custom_json_operation, (required_auths)(required_posting_auths)(id)(json) )
FC_REFLECT( bearshares::protocol::custom_binary_operation, (required_owner_auths)(required_active_auths)(required_posting_auths)(required_auths)(id)(data) )
FC_REFLECT( bearshares::protocol::limit_order_create_operation, (owner)(orderid)(amount_to_sell)(min_to_receive)(fill_or_kill)(expiration) )
FC_REFLECT( bearshares::protocol::limit_order_create2_operation, (owner)(orderid)(amount_to_sell)(exchange_rate)(fill_or_kill)(expiration) )
FC_REFLECT( bearshares::protocol::limit_order_cancel_operation, (owner)(orderid) )

FC_REFLECT( bearshares::protocol::delete_comment_operation, (author)(permlink) );

FC_REFLECT( bearshares::protocol::beneficiary_route_type, (account)(weight) )
FC_REFLECT( bearshares::protocol::comment_payout_beneficiaries, (beneficiaries) )
FC_REFLECT_TYPENAME( bearshares::protocol::comment_options_extension )
FC_REFLECT( bearshares::protocol::comment_options_operation, (author)(permlink)(max_accepted_payout)(percent_bears_dollars)(allow_votes)(allow_curation_rewards)(extensions) )

FC_REFLECT( bearshares::protocol::escrow_transfer_operation, (from)(to)(bsd_amount)(bears_amount)(escrow_id)(agent)(fee)(json_meta)(ratification_deadline)(escrow_expiration) );
FC_REFLECT( bearshares::protocol::escrow_approve_operation, (from)(to)(agent)(who)(escrow_id)(approve) );
FC_REFLECT( bearshares::protocol::escrow_dispute_operation, (from)(to)(agent)(who)(escrow_id) );
FC_REFLECT( bearshares::protocol::escrow_release_operation, (from)(to)(agent)(who)(receiver)(escrow_id)(bsd_amount)(bears_amount) );
FC_REFLECT( bearshares::protocol::challenge_authority_operation, (challenger)(challenged)(require_owner) );
FC_REFLECT( bearshares::protocol::prove_authority_operation, (challenged)(require_owner) );
FC_REFLECT( bearshares::protocol::request_account_recovery_operation, (recovery_account)(account_to_recover)(new_owner_authority)(extensions) );
FC_REFLECT( bearshares::protocol::recover_account_operation, (account_to_recover)(new_owner_authority)(recent_owner_authority)(extensions) );
FC_REFLECT( bearshares::protocol::change_recovery_account_operation, (account_to_recover)(new_recovery_account)(extensions) );
FC_REFLECT( bearshares::protocol::decline_voting_rights_operation, (account)(decline) );
FC_REFLECT( bearshares::protocol::claim_reward_balance_operation, (account)(reward_bears)(reward_bsd)(reward_coins) )
FC_REFLECT( bearshares::protocol::delegate_coining_shares_operation, (delegator)(delegatee)(coining_shares) );
