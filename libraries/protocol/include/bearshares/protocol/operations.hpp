...
#include <bearshares/protocol/bears_virtual_operations.hpp>
...
/*namespace fc {
    void to_variant( const bearshares::protocol::operation& var,  fc::variant& vo );
    void from_variant( const fc::variant& var,  bearshares::protocol::operation& vo );
}*/

DECLARE_OPERATION_TYPE( bearshares::protocol::operation )
FC_REFLECT_TYPENAME( bearshares::protocol::operation )
