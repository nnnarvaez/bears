#pragma once
#include <bearshares/app/applied_operation.hpp>
#include <bearshares/app/bears_api_objects.hpp>
...
namespace bearshares { namespace app {
   ...
   struct extended_account : public account_api_obj
   {
      ...
      asset                                   coining_balance; /// convert coining_shares to coining bears
      share_type                              reputation = 0;
      map<uint64_t,applied_operation>         transfer_history; /// transfer to/from coining
...
FC_REFLECT_DERIVED( bearshares::app::extended_account,
                   (bearshares::app::account_api_obj),
                   (coining_balance)(reputation)
...
FC_REFLECT( bearshares::app::vote_state, (voter)(weight)(rshares)(percent)(reputation)(time) );
FC_REFLECT( bearshares::app::account_vote, (authorperm)(weight)(rshares)(percent)(time) );

FC_REFLECT( bearshares::app::discussion_index, (category)(trending)(payout)(payout_comments)(trending30)(updated)(created)(responses)(active)(votes)(maturing)(best)(hot)(promoted)(cashout) )
FC_REFLECT( bearshares::app::tag_index, (trending) )
FC_REFLECT_DERIVED( bearshares::app::discussion, (bearshares::app::comment_api_obj), (url)(root_title)(pending_payout_value)(total_pending_payout_value)(active_votes)(replies)(author_reputation)(promoted)(body_length)(reblogged_by)(first_reblogged_by)(first_reblogged_on) )

FC_REFLECT( bearshares::app::state, (current_route)(props)(tag_idx)(tags)(content)(accounts)(pow_queue)(witnesses)(discussion_idx)(witness_schedule)(feed_price)(error)(market_data) )

FC_REFLECT_DERIVED( bearshares::app::extended_limit_order, (bearshares::app::limit_order_api_obj), (real_price)(rewarded) )
FC_REFLECT( bearshares::app::order_history_item, (time)(type)(bsd_quantity)(bears_quantity)(real_price) );
FC_REFLECT( bearshares::app::market, (bids)(asks)(history)(price_history)(available_candlesticks)(available_zoom)(current_candlestick)(current_zoom) )
FC_REFLECT( bearshares::app::candle_stick, (open_time)(period)(high)(low)(open)(close)(bears_volume)(dollar_volume) );
