...
typedef chain::withdraw_coining_route_object           withdraw_coining_route_api_obj;
...
typedef chain::coining_delegation_object               coining_delegation_api_obj;
typedef chain::coining_delegation_expiration_object    coining_delegation_expiration_api_obj;
...
FC_REFLECT( bearshares::app::comment_api_obj,
             (id)(author)(permlink)
...
FC_REFLECT( bearshares::app::account_api_obj,
...
FC_REFLECT( bearshares::app::owner_authority_history_api_obj,
             (id)
             (account)
...
FC_REFLECT( bearshares::app::account_recovery_request_api_obj,
             (id)
             (account_to_recover)
             (new_owner_authority)
             (expires)
...
FC_REFLECT( bearshares::app::savings_withdraw_api_obj,
             (id)
             (from)
             (to)
             (memo)
...
FC_REFLECT( bearshares::app::feed_history_api_obj,
             (id)
             (current_median_history)
             (price_history)
          )

FC_REFLECT( bearshares::app::tag_api_obj,
            (name)
            (total_payouts)
            (net_votes)
            (top_posts)
...
FC_REFLECT( bearshares::app::witness_api_obj,
             (id)
             (owner)
             (created)
...
FC_REFLECT_DERIVED( bearshares::app::signed_block_api_obj, (bearshares::protocol::signed_block),
                     (block_id)
                     (signing_key)
                     (transaction_ids)
                  )

FC_REFLECT_DERIVED( bearshares::app::dynamic_global_property_api_obj, (bearshares::chain::dynamic_global_property_object),
