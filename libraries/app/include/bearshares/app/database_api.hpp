...
#include <bearshares/app/state.hpp>
...
#include <bearshares/tags/tags_plugin.hpp>
...
{
   public:
      database_api(const bearshares::app::api_context& ctx);
      ~database_api();
      ...
      vector< coining_delegation_api_obj > get_coining_delegations( string account, string from, uint32_t limit = 100 )const;
      vector< coining_delegation_expiration_api_obj > get_expiring_coining_delegations( string account, time_point_sec from, uint32_t limit = 100 )const;
      ...
      /**
       * @breif Gets the current order book for BEARS:BSD market
...
FC_REFLECT( bearshares::app::order, (order_price)(real_price)(bears)(bsd)(created) );
FC_REFLECT( bearshares::app::order_book, (asks)(bids) );
FC_REFLECT( bearshares::app::scheduled_hardfork, (hf_version)(live_time) );
FC_REFLECT( bearshares::app::liquidity_balance, (account)(weight) );
FC_REFLECT( bearshares::app::withdraw_route, (from_account)(to_account)(percent)(auto_coin) );

FC_REFLECT( bearshares::app::discussion_query, (tag)(filter_tags)(select_tags)(select_authors)(truncate_body)(start_author)(start_permlink)(parent_author)(parent_permlink)(limit) );

FC_REFLECT_ENUM( bearshares::app::withdraw_route_type, (incoming)(outgoing)(all) );

FC_API(bearshares::app::database_api,
   // Subscriptions
