...
)
{
   ...
   bearshares::chain::public_key_type debug_public_key;
   if( debug_key != "" )
   {
   ...
   bearshares::chain::database& db = database();
   ...
   while( produced < count )
   {
      ...
      bearshares::chain::public_key_type scheduled_key = scheduled_witness.signing_key;
      if( debug_key != "" )
      {
...
BEARSHARES_DEFINE_PLUGIN( debug_node, bearshares::plugin::debug_node::debug_node_plugin )
