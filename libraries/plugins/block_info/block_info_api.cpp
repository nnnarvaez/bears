...
#include <bearshares/plugins/block_info/block_info_api.hpp>
#include <bearshares/plugins/block_info/block_info_plugin.hpp>
...
{
   public:
      block_info_api_impl( bearshares::app::application& _app );

      std::shared_ptr< bearshares::plugin::block_info::block_info_plugin > get_plugin();
...
block_info_api_impl::block_info_api_impl( bearshares::app::application& _app ) : app( _app )
{}

std::shared_ptr< bearshares::plugin::block_info::block_info_plugin > block_info_api_impl::get_plugin()
{
...
block_info_api::block_info_api( const bearshares::app::api_context& ctx )
{
