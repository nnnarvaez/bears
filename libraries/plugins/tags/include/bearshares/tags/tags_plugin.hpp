...
namespace bearshares { namespace tags {
 ...
 *
 */
class tags_plugin : public bearshares::app::plugin
{
   public:
...
FC_API( bearshares::tags::tag_api, (get_tags) );

FC_REFLECT( bearshares::tags::tag_object,
   (id)(tag)(created)(active)(cashout)(net_rshares)(net_votes)(hot)(trending)(promoted_balance)(children)(author)(parent)(comment) )
CHAINBASE_SET_INDEX_TYPE( bearshares::tags::tag_object, bearshares::tags::tag_index )

FC_REFLECT( bearshares::tags::tag_stats_object,
   (id)(tag)(total_payout)(net_votes)(top_posts)(comments)(total_trending) );
CHAINBASE_SET_INDEX_TYPE( bearshares::tags::tag_stats_object, bearshares::tags::tag_stats_index )

FC_REFLECT( bearshares::tags::peer_stats_object,
   (id)(voter)(peer)(direct_positive_votes)(direct_votes)(indirect_positive_votes)(indirect_votes)(rank) );
CHAINBASE_SET_INDEX_TYPE( bearshares::tags::peer_stats_object, bearshares::tags::peer_stats_index )

FC_REFLECT( bearshares::tags::comment_metadata, (tags) );

FC_REFLECT( bearshares::tags::author_tag_stats_object, (id)(author)(tag)(total_posts)(total_rewards) )
CHAINBASE_SET_INDEX_TYPE( bearshares::tags::author_tag_stats_object, bearshares::tags::author_tag_stats_index )
