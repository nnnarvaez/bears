...
FC_REFLECT( bearshares::account_by_key::key_lookup_object, (id)(key)(account) )
CHAINBASE_SET_INDEX_TYPE( bearshares::account_by_key::key_lookup_object, bearshares::account_by_key::key_lookup_index )
