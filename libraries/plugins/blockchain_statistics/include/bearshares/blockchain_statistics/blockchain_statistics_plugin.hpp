...
class blockchain_statistics_plugin : public bearshares::app::plugin
{
   public:
...
FC_REFLECT( bearshares::blockchain_statistics::bucket_object,
   (id)
   (open)
   (seconds)
   (blocks)
...
CHAINBASE_SET_INDEX_TYPE( bearshares::blockchain_statistics::bucket_object, bearshares::blockchain_statistics::bucket_index )
