...
#include <bearshares/blockchain_statistics/blockchain_statistics_plugin.hpp>
...
{
   public:
      blockchain_statistics_api( const bearshares::app::api_context& ctx );
...
FC_REFLECT( bearshares::blockchain_statistics::statistics,
   (blocks)
   (bandwidth)
   (operations)
   (transactions)
...
FC_API( bearshares::blockchain_statistics::blockchain_statistics_api,
   (get_stats_for_time)
