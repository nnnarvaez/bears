...
class account_statistics_plugin : public bearshares::app::plugin
{
   public:
...
FC_REFLECT( bearshares::account_statistics::account_stats_bucket_object,
   (id)
   (open)
   (seconds)
   (name)
...
//SET_INDEX_TYPE( bearshares::account_statistics::account_stats_bucket_object,)

FC_REFLECT(
   bearshares::account_statistics::account_activity_bucket_object,
   (id)
   (open)
   (seconds)
