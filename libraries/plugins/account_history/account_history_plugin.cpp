...
#define BEARS_NAMESPACE_PREFIX "bearshares::protocol::"

namespace bearshares { namespace account_history {
...
BEARSHARES_DEFINE_PLUGIN( account_history, bearshares::account_history::account_history_plugin )
