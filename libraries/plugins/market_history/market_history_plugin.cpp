#include <bearshares/market_history/market_history_api.hpp>
...
using bearshares::protocol::fill_order_operation;
      ...
      for( auto bucket : _tracked_buckets )
      {
         ...
         if( itr == bucket_idx.end() )
         {
            db.create< bucket_object >( [&]( bucket_object& b )
            {
               ...
               {
                  b.high_bears = op.open_pays.amount;
                  b.high_bsd = op.current_pays.amount;
                  b.low_bears = op.open_pays.amount;
                  b.low_bsd = op.current_pays.amount;
                  b.open_bears = op.open_pays.amount;
                  b.open_bsd = op.current_pays.amount;
                  b.close_bears = op.open_pays.amount;
                  b.close_bsd = op.current_pays.amount;
                  b.bears_volume = op.open_pays.amount;
                  b.bsd_volume = op.current_pays.amount;
               }
               else
               {
                  b.high_bears = op.current_pays.amount;
                  b.high_bsd = op.open_pays.amount;
                  b.low_bears = op.current_pays.amount;
                  b.low_bsd = op.open_pays.amount;
                  b.open_bears = op.current_pays.amount;
                  b.open_bsd = op.open_pays.amount;
                  b.close_bears = op.current_pays.amount;
                  b.close_bsd = op.open_pays.amount;
                  b.bears_volume = op.current_pays.amount;
                  b.bsd_volume = op.open_pays.amount;
               }
            });
         }
         else
...
BEARSHARES_DEFINE_PLUGIN( market_history, bearshares::market_history::market_history_plugin )
