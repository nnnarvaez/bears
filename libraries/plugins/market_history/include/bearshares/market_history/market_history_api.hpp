...
{
   public:
      market_history_api( const bearshares::app::api_context& ctx );

      void on_api_startup();

      /**
       * @brief Returns the market ticker for the internal BSD:BEARS market
       */
      ...
      /**
       * @brief Returns the current order book for the internal BSD:BEARS market.
      ...
      /**
       * @brief Returns the trade history for the internal BSD:BEARS market.
      ...
      /**
       * @brief Returns the N most recent trades for the internal BSD:BEARS market.
      ...
      /**
       * @brief Returns the market history for the internal BSD:BEARS market.
...
FC_REFLECT( bearshares::market_history::market_ticker,
   (latest)(lowest_ask)(highest_bid)(percent_change)(bears_volume)(bsd_volume) );
FC_REFLECT( bearshares::market_history::market_volume,
   (bears_volume)(bsd_volume) );
FC_REFLECT( bearshares::market_history::order,
   (price)(bears)(bsd) );
FC_REFLECT( bearshares::market_history::order_book,
   (bids)(asks) );
FC_REFLECT( bearshares::market_history::market_trade,
   (date)(current_pays)(open_pays) );

FC_API( bearshares::market_history::market_history_api,
   (get_ticker)
   (get_volume)
   (get_order_book)
   (get_trade_history)
