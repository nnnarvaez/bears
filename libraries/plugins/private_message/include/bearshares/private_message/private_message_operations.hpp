...
struct private_message_operation : public bearshares::protocol::base_operation
{
...
FC_REFLECT( bearshares::private_message::private_message_operation, (from)(to)(from_memo_key)(to_memo_key)(sent_time)(checksum)(encrypted_message) )

DECLARE_OPERATION_TYPE( bearshares::private_message::private_message_plugin_operation )
FC_REFLECT_TYPENAME( bearshares::private_message::private_message_plugin_operation )
