...
FC_REFLECT_ENUM( bearshares::follow::follow_type, (undefined)(blog)(ignore) )

FC_REFLECT( bearshares::follow::follow_object, (id)(follower)(following)(what) )
CHAINBASE_SET_INDEX_TYPE( bearshares::follow::follow_object, bearshares::follow::follow_index )

FC_REFLECT( bearshares::follow::feed_object, (id)(account)(first_reblogged_by)(first_reblogged_on)(reblogged_by)(comment)(reblogs)(account_feed_id) )
CHAINBASE_SET_INDEX_TYPE( bearshares::follow::feed_object, bearshares::follow::feed_index )

FC_REFLECT( bearshares::follow::blog_object, (id)(account)(comment)(reblogged_on)(blog_feed_id) )
CHAINBASE_SET_INDEX_TYPE( bearshares::follow::blog_object, bearshares::follow::blog_index )

FC_REFLECT( bearshares::follow::reputation_object, (id)(account)(reputation) )
CHAINBASE_SET_INDEX_TYPE( bearshares::follow::reputation_object, bearshares::follow::reputation_index )

FC_REFLECT( bearshares::follow::follow_count_object, (id)(account)(follower_count)(following_count) )
CHAINBASE_SET_INDEX_TYPE( bearshares::follow::follow_count_object, bearshares::follow::follow_count_index )

FC_REFLECT( bearshares::follow::blog_author_stats_object, (id)(blogger)(guest)(count) )
CHAINBASE_SET_INDEX_TYPE( bearshares::follow::blog_author_stats_object, bearshares::follow::blog_author_stats_index );
