...
FC_REFLECT( bearshares::follow::follow_operation, (follower)(following)(what) )
FC_REFLECT( bearshares::follow::reblog_operation, (account)(author)(permlink) )

DECLARE_OPERATION_TYPE( bearshares::follow::follow_plugin_operation )

FC_REFLECT_TYPENAME( bearshares::follow::follow_plugin_operation )
