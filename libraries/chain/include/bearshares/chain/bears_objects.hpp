...
namespace bearshares { namespace chain {
   ...
   using bearshares::protocol::asset_symbol_type;
      ...
      indexed_by<
         ...
         ordered_unique< tag< by_withdraw_route >,
            composite_key< withdraw_coining_route_object,
               member< withdraw_coining_route_object, account_id_type, &withdraw_coining_route_object::from_account >,
               member< withdraw_coining_route_object, account_id_type, &withdraw_coining_route_object::to_account >
            >,
   ...
   typedef multi_index_container<
      ...
      indexed_by<
         ...
         >,
         ordered_unique< tag< by_bsd_balance >,
            composite_key< escrow_object,
               member< escrow_object, asset, &escrow_object::bsd_balance >,
               member< escrow_object, escrow_id_type, &escrow_object::id >
            >,
...
FC_REFLECT_ENUM( bearshares::chain::curve_id,
                  (quadratic)(quadratic_curation)(linear)(square_root))

FC_REFLECT( bearshares::chain::limit_order_object,
             (id)(created)(expiration)(seller)(orderid)(for_sale)(sell_price) )
CHAINBASE_SET_INDEX_TYPE( bearshares::chain::limit_order_object, bearshares::chain::limit_order_index )

FC_REFLECT( bearshares::chain::feed_history_object,
             (id)(current_median_history)(price_history) )
CHAINBASE_SET_INDEX_TYPE( bearshares::chain::feed_history_object, bearshares::chain::feed_history_index )

FC_REFLECT( bearshares::chain::convert_request_object,
             (id)(owner)(requestid)(amount)(conversion_date) )
CHAINBASE_SET_INDEX_TYPE( bearshares::chain::convert_request_object, bearshares::chain::convert_request_index )

FC_REFLECT( bearshares::chain::liquidity_reward_balance_object,
             (id)(owner)(bears_volume)(bsd_volume)(weight)(last_update) )
CHAINBASE_SET_INDEX_TYPE( bearshares::chain::liquidity_reward_balance_object, bearshares::chain::liquidity_reward_balance_index )

FC_REFLECT( bearshares::chain::withdraw_coining_route_object,
             (id)(from_account)(to_account)(percent)(auto_coin) )
CHAINBASE_SET_INDEX_TYPE( bearshares::chain::withdraw_coining_route_object, bearshares::chain::withdraw_coining_route_index )

FC_REFLECT( bearshares::chain::savings_withdraw_object,
             (id)(from)(to)(memo)(request_id)(amount)(complete) )
CHAINBASE_SET_INDEX_TYPE( bearshares::chain::savings_withdraw_object, bearshares::chain::savings_withdraw_index )

FC_REFLECT( bearshares::chain::escrow_object,
             (id)(escrow_id)(from)(to)(agent)
             (ratification_deadline)(escrow_expiration)
             (bsd_balance)(bears_balance)(pending_fee)
             (to_approved)(agent_approved)(disputed) )
CHAINBASE_SET_INDEX_TYPE( bearshares::chain::escrow_object, bearshares::chain::escrow_index )

FC_REFLECT( bearshares::chain::decline_voting_rights_request_object,
             (id)(account)(effective_date) )
CHAINBASE_SET_INDEX_TYPE( bearshares::chain::decline_voting_rights_request_object, bearshares::chain::decline_voting_rights_request_index )

FC_REFLECT( bearshares::chain::reward_fund_object,
            (id)
            (name)
            (reward_balance)
            (recent_claims)
...
CHAINBASE_SET_INDEX_TYPE( bearshares::chain::reward_fund_object, bearshares::chain::reward_fund_index )
