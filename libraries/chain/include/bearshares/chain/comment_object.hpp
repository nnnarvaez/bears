...
FC_REFLECT( bearshares::chain::comment_object,
             (id)(author)(permlink)
...
CHAINBASE_SET_INDEX_TYPE( bearshares::chain::comment_object, bearshares::chain::comment_index )

FC_REFLECT( bearshares::chain::comment_vote_object,
             (id)(voter)(comment)(weight)(rshares)(vote_percent)(last_update)(num_changes)
          )
CHAINBASE_SET_INDEX_TYPE( bearshares::chain::comment_vote_object, bearshares::chain::comment_vote_index )
