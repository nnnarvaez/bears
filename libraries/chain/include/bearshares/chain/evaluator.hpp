...
template< typename OperationType=bearshares::protocol::operation >
class evaluator
{
   public:
...
template< typename EvaluatorType, typename OperationType=bearshares::protocol::operation >
...
class X ## _evaluator : public bearshares::chain::evaluator_impl< X ## _evaluator > \
{                                                                           \
   public:                                                                  \
      typedef X ## _operation operation_type;                               \
                                                                            \
      X ## _evaluator( database& db )                                       \
         : bearshares::chain::evaluator_impl< X ## _evaluator >( db )          \
      {}                                                                    \
                                                                            \
