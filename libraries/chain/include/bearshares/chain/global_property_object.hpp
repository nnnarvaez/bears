...
namespace bearshares { namespace chain {
   ...
   class dynamic_global_property_object : public object< dynamic_global_property_object_type, dynamic_global_property_object>
   {
      public:
         ...
         uint16_t bsd_print_rate = BEARSHARES_100_PERCENT;
...
FC_REFLECT( bearshares::chain::dynamic_global_property_object,
             (id)
             (head_block_number)
             (head_block_id)
             (time)
...
CHAINBASE_SET_INDEX_TYPE( bearshares::chain::dynamic_global_property_object, bearshares::chain::dynamic_global_property_index )
