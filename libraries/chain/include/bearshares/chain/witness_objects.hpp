...
namespace bearshares { namespace chain {
   ...
   using bearshares::protocol::chain_properties;
   using bearshares::protocol::digest_type;
   using bearshares::protocol::public_key_type;
   using bearshares::protocol::version;
   using bearshares::protocol::hardfork_version;
   ...
   class witness_object : public object< witness_object_type, witness_object >
   {
      ...
      public:
         ...
         time_point_sec    hardfork_time_vote = BEARSHARES_GENESIS_TIME;
   };
   ...
   class witness_schedule_object : public object< witness_schedule_object_type, witness_schedule_object >
   {
      public:
         ...
         fc::array< account_name_type, BEARSHARES_MAX_WITNESSES >             current_shuffled_witnesses;
         ...
         uint8_t max_voted_witnesses            = BEARSHARES_MAX_VOTED_WITNESSES_HF0;
         uint8_t max_miner_witnesses            = BEARSHARES_MAX_MINER_WITNESSES_HF0;
         uint8_t max_runner_witnesses           = BEARSHARES_MAX_RUNNER_WITNESSES_HF0;
         uint8_t hardfork_required_witnesses    = BEARSHARES_HARDFORK_REQUIRED_WITNESSES;
   };
...
FC_REFLECT_ENUM( bearshares::chain::witness_object::witness_schedule_type, (top19)(timeshare)(miner)(none) )

FC_REFLECT( bearshares::chain::witness_object,
             (id)
             (owner)
             (created)
...
CHAINBASE_SET_INDEX_TYPE( bearshares::chain::witness_object, bearshares::chain::witness_index )

FC_REFLECT( bearshares::chain::witness_vote_object, (id)(witness)(account) )
CHAINBASE_SET_INDEX_TYPE( bearshares::chain::witness_vote_object, bearshares::chain::witness_vote_index )

FC_REFLECT( bearshares::chain::witness_schedule_object,
...
CHAINBASE_SET_INDEX_TYPE( bearshares::chain::witness_schedule_object, bearshares::chain::witness_schedule_index )
