...
DEFINE_EVALUATOR( transfer_to_coining )
DEFINE_EVALUATOR( witness_update )
DEFINE_EVALUATOR( account_witness_vote )
DEFINE_EVALUATOR( account_witness_proxy )
DEFINE_EVALUATOR( withdraw_coining )
DEFINE_EVALUATOR( set_withdraw_coining_route )
...
DEFINE_EVALUATOR( delegate_coining_shares )
