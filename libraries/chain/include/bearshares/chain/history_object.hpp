...
FC_REFLECT( bearshares::chain::operation_object, (id)(trx_id)(block)(trx_in_block)(op_in_trx)(virtual_op)(timestamp)(serialized_op) )
CHAINBASE_SET_INDEX_TYPE( bearshares::chain::operation_object, bearshares::chain::operation_index )

FC_REFLECT( bearshares::chain::account_history_object, (id)(account)(sequence)(op) )
CHAINBASE_SET_INDEX_TYPE( bearshares::chain::account_history_object, bearshares::chain::account_history_index )
