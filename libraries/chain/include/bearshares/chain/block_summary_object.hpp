...
FC_REFLECT( bearshares::chain::block_summary_object, (id)(block_id) )
CHAINBASE_SET_INDEX_TYPE( bearshares::chain::block_summary_object, bearshares::chain::block_summary_index )
