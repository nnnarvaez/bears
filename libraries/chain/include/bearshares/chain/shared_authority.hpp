...
namespace bearshares { namespace chain {
   ...
   using bearshares::protocol::weight_type;
...
FC_REFLECT_TYPENAME( bearshares::chain::shared_authority::account_authority_map)
FC_REFLECT( bearshares::chain::shared_authority, (weight_threshold)(account_auths)(key_auths) )
