...
namespace bearshares { namespace example_plugin {

class hello_api_plugin : public bearshares::app::plugin
{
   public:
      /**
       ...
       */
      hello_api_plugin( bearshares::app::application* app );
...
{
   public:
      hello_api_api( const bearshares::app::api_context& ctx );
...
FC_API( bearshares::example_plugin::hello_api_api,
   (get_message)
   )

namespace bearshares { namespace example_plugin {

hello_api_plugin::hello_api_plugin( bearshares::app::application* app ) : bearshares::app::plugin(app) {}
...
hello_api_api::hello_api_api( const bearshares::app::api_context& ctx ) : _app(ctx.app) {}
...
/**
 * The BEARSHARES_DEFINE_PLUGIN() macro will define a bearshares::plugin::create_hello_api_plugin()
 * factory method which is expected by the manifest.
 */

BEARSHARES_DEFINE_PLUGIN( hello_api, bearshares::example_plugin::hello_api_plugin )
