...
{{
   public:
      {plugin_name}_api( const bearshares::app::api_context& ctx );
...
class {plugin_name}_plugin : public bearshares::app::plugin
{{
   public:
      {plugin_name}_plugin( bearshares::app::application* app );
...
{{
   public:
      {plugin_name}_api_impl( bearshares::app::application& _app );
...
{plugin_name}_api_impl::{plugin_name}_api_impl( bearshares::app::application& _app ) : app( _app )
{{}}
...
{plugin_name}_api::{plugin_name}_api( const bearshares::app::api_context& ctx )
{{
...
{{
   public:
      {plugin_name}_plugin_impl( bearshares::app::application& app );
...
{plugin_name}_plugin_impl::{plugin_name}_plugin_impl( bearshares::app::application& app )
  : _app(app) {{}}
...
{plugin_name}_plugin::{plugin_name}_plugin( bearshares::app::application* app )
   : plugin(app)
{{
...
BEARSHARES_DEFINE_PLUGIN( {plugin_name}, {plugin_provider}::plugin::{plugin_name}::{plugin_name}_plugin )
""",
}
...
def main(argv):
    ...
    parser.add_argument("provider", help="Name of plugin provider (bearshares for plugins developed by Bearshares)")
